...
CUDA_VISIBLE_DEVICES=$devices vllm serve $3 --trust-remote-code --tensor-parallel-size $tensor_parallel_size --gpu-memory-utilization 0.8 --port 9000 --enable-auto-tool-choice --tool-call-parser hermes &
# sleep 120
