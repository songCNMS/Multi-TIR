...
# TOOL_CALL_DENSE_REWARD_ON=true DENSE_REWARD_ON=false python train_search_agent.py --llm-proxy --model Qwen/Qwen3-4B-Instruct-2507 --n-gpus 4 --exp-name fa-gpt_tc-on_ds-off_syn  2>&1 | tee agent_train.log